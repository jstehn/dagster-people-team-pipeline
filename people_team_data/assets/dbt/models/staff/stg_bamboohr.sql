...
with raw as (
    select
        {% if target.name == 'duckdb_dev' %}
            ...
            TRY_CAST(gender_identity AS STRING) as gender_identity,
            TRY_CAST(employee_pronouns AS STRING) as employee_pronouns,
            ...
            TRY_CAST(national_id AS STRING) as national_id,
            TRY_CAST(nationality AS STRING) as nationality,
            TRY_CAST(citizenship AS STRING) as citizenship,
            ...
            TRY_CAST(pay_group AS STRING) as pay_group,
            TRY_CAST(flsa_code AS STRING) as flsa_code,
            TRY_CAST(eeo_job_category AS STRING) as eeo_job_category,
